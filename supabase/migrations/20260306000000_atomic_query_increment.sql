-- Atomic query increment: prevents TOCTOU race in read-check-write pattern.
-- Uses FOR UPDATE row lock so concurrent requests can't both read count=9
-- and both write count=10 when the limit is 10.
